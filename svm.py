...
class RealsenseCamera:
    ...
    def get_frame_stream(self):
        ...
        while True:
            ...
            depth=resize(depth_colormap,(64,64))
            hog_desc, hog_image = hog(depth_image,orientations=8,pixels_per_cell=(16,16),cells_per_block=(1,1),visualize=True,channel_axis=True)
            #hog_desc, hog_image = hog(depth_colormap,orientations=8,pixels_per_cell=(16,16),cells_per_block=(1,1),visualize=True,channel_axis=True)
